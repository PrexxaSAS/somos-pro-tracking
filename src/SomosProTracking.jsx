 acimport React, { useState, useEffect, useRef } from 'react';
...
function Usuarios({ usuarios, setUsuarios, showToast }) {
  ...
  const abrirEditar = (u) => {
    setForm({ nombre:u.nombre, user:u.user, pass:u.pass, rol:u.rol, nit:u.nit||"", empresa:u.empresa||"", placa:u.placa||"", nit_proveedor:u.nit_proveedor||"", celular:u.celular||"" });
    setModEditar(u);
  };
  ...
  const guardarEdicion = () => {
    ...
    if (conflict) { showToast("Ese nombre de usuario ya lo usa otra persona","error"); return; }
