  ...
  return (
    <div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(260px,1fr))",gap:14}}>
        {conductores.map(c=>{
          const asig=pedidos.filter(p=>String(p.conductor_id)===String(c.id)).length;
          const tran=pedidos.filter(p=>String(p.conductor_id)===String(c.id)&&p.estado==="en_transito").length;
          return (
