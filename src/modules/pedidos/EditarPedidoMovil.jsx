...
import {
 AlertTriangle, Calendar, Camera, Check, ChevronDown, FileText, Image as Imagen,
 Info, Lock, Map as IconoMapa, Minus, Phone, Plus, Search, UserCheck, UserPlus, X,
} from 'lucide-react';
...
export function EditarPedidoMovil({
 ...
 // Cuantos soportes hay ya guardados y cuantos caben todavia. El maximo son
 // tres, como en el modal de escritorio.
 const guardados = (pedido.soportes || []).length;
 const cupoFotos = Math.max(0, 3 - guardados - e.fotosPendientes.length);
 const puedeAdjuntar = !e.pedidoCerrado && (!e.pedidoEnTransito || canDeliver);
 ...
 return (
  <div style={{
   ...
   <div style={{
    ...
    {/* Adjuntar el soporte cierra el pedido al guardar, asi que va con su
        aviso y con la casilla de novedad: es lo mismo que hace el modal de
        escritorio, que en el celular se habia quedado por fuera. */}
    {!e.pedidoCerrado && (
     <>
