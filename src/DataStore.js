export const USUARIOS_INICIALES = [
  ...
  { id: 4, nombre: "Juan Pérez",              user: "driver1",  pass: "cond123",    rol: "conductor", placa: "ABC-123", celular: "3001234567", nit_proveedor: "900123456-1", empresa: "Transportes Veloz S.A.S" },
  { id: 5, nombre: "Almacén Central",         user: "cliente",  pass: "cli123",     rol: "cliente" },
];

export const CONDUCTORES_INICIALES = [
  { id: 4, nombre: "Juan Pérez", placa: "ABC-123", celular: "3001234567", nit_proveedor: "900123456-1", empresa: "Transportes Veloz S.A.S", activo: true },
];
